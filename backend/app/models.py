...
class Transaction(Base):
    ...
    transaction_status: Mapped[str] = mapped_column(String(40), default="EXECUTED", index=True)
    ...
    admin_decided_by_user_id: Mapped[int | None] = mapped_column(Integer, nullable=True)
